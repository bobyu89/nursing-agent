...
const RULE_REGISTRY = {
  ...
  hard: [
    ...
    },
    {
      code: 'H10',
      name: '個人限制班別（母性保護等）',
      desc: '人員主檔登錄之個人限制期間內，不得排入受限班別——如妊娠與哺乳期間不得排大夜（示範以班別為粒度；法定禁止時段為 22:00 起，正式導入應以時段判定）',
      basis: '勞動基準法第 49 條（妊娠或哺乳期間女工不得於午後十時至翌晨六時工作）＋醫囑／院內個人限制登錄',
      relax: { allowed: false, note: '法定禁止與醫囑限制，不得放寬。人力不足應改由其他人員承接或啟動任務重分配' },
      enabled: true,
    },
  ],
