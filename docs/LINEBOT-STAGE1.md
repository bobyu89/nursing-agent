...
`richmenu.ps1` 現有的建立與掛載流程沿用，改成建四份、由宿主依 tier 掛。
...
| **1 替班迴路** ✅ 2026-09-19 | §4 全部：通報→核准→逐一問→逾時→寫回→回報（v1 的「調整」＝略過；調序、改逾時、圖文選單分流留 1.5） | **當天就能實測**的完整迴路；landing page「我們開始在那通電話」成真 | 2–3 週 |
